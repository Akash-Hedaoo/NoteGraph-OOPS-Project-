...
public class ApiClient {
    ...
    public String formatContent(String content) throws Exception {
        String requestJson = "{\"content\":\"" + content.replace("\"", "\\\"").replace("\n", "\\n").replace("\r", "") + "\"}";
        String body = post("/ai/format", requestJson);
        java.util.Map<String, String> response = gson.fromJson(body, new TypeToken<java.util.Map<String, String>>(){}.getType());
