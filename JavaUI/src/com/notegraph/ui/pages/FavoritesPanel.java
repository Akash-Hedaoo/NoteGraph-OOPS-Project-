...
public class FavoritesPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        JLabel title = new JLabel("Favorites", new VectorIcon(VectorIcon.Type.STAR_FILLED, 20, ColorScheme.TEXT_PRIMARY), SwingConstants.LEFT);
    ...
    private RoundedPanel createFavCard(ApiModels.Note note) {
        ...
        JLabel starBtn = new JLabel(new VectorIcon(VectorIcon.Type.STAR_FILLED, 18, ColorScheme.STAR_COLOR));
        ...
        JLabel typeLabel = new JLabel("Note", new VectorIcon(VectorIcon.Type.BOOK, 12, ColorScheme.TEXT_SECONDARY), SwingConstants.LEFT);
    ...
    private void filterFavs() {
        ...
        if (count == 0) {
            ...
            JLabel emptyIcon = new JLabel(new VectorIcon(VectorIcon.Type.STAR_FILLED, 48, ColorScheme.TEXT_SECONDARY));
