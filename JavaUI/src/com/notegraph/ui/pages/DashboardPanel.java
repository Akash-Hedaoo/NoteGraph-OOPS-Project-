...
public class DashboardPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        metricsPanel.add(createMetricCard("Total Notes", "...", new VectorIcon(VectorIcon.Type.BOOK, 18, ColorScheme.TEXT_SECONDARY)));
        metricsPanel.add(createMetricCard("Recent Edits", "...", new VectorIcon(VectorIcon.Type.EDIT, 18, ColorScheme.TEXT_SECONDARY)));
        metricsPanel.add(createMetricCard("Favorites", "...", new VectorIcon(VectorIcon.Type.STAR_FILLED, 18, ColorScheme.TEXT_SECONDARY)));
        metricsPanel.add(createMetricCard("Archived", "0", new VectorIcon(VectorIcon.Type.FOLDER, 18, ColorScheme.TEXT_SECONDARY)));
    ...
    private RoundedPanel createMetricCard(String title, String value, Icon icon) {
    ...
    private RoundedPanel createNoteCard(ApiModels.Note note) {
        ...
        JLabel deleteBtn = new JLabel(new VectorIcon(VectorIcon.Type.TRASH, 16, ColorScheme.TEXT_TERTIARY));
    ...
    private RoundedPanel createNewNoteCard() {
        ...
        JLabel plusIcon = new JLabel(new VectorIcon(VectorIcon.Type.PLUS, 24, ColorScheme.PRIMARY_BLUE));
    ...
    public void refreshData() {
        new SwingWorker<Void, Void>() {
            ...
            protected void done() {
                ...
                metricsPanel.add(createMetricCard("Total Notes", String.valueOf(notes.size()), new VectorIcon(VectorIcon.Type.BOOK, 18, ColorScheme.TEXT_SECONDARY)));
                long edits = activities.stream().filter(a -> "edited".equals(a.action)).count();
                metricsPanel.add(createMetricCard("Recent Edits", String.valueOf(edits), new VectorIcon(VectorIcon.Type.EDIT, 18, ColorScheme.TEXT_SECONDARY)));
                long favs = notes.stream().filter(n -> Boolean.TRUE.equals(n.favorite)).count();
                metricsPanel.add(createMetricCard("Favorites", String.valueOf(favs), new VectorIcon(VectorIcon.Type.STAR_FILLED, 18, ColorScheme.TEXT_SECONDARY)));
                metricsPanel.add(createMetricCard("Archived", "0", new VectorIcon(VectorIcon.Type.FOLDER, 18, ColorScheme.TEXT_SECONDARY)));
    ...
    private JPanel createActivityItem(ApiModels.ActivityLog log) {
        ...
        JLabel dot = new JLabel(new VectorIcon(VectorIcon.Type.DOT, 8, "edited".equals(log.action) ? ColorScheme.SUCCESS_TEXT : ColorScheme.PRIMARY_BLUE));
