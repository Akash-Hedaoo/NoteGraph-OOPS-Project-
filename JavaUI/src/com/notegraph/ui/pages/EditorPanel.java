...
public class EditorPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        dateLabel = new JLabel("📅 " + LocalDateTime.now().format(DateTimeFormatter.ofPattern("MMM dd, yyyy")));
        ...
        toolbar.add(createToolbarBtn("B", () -> applyStyle("bold")));
        toolbar.add(createToolbarBtn("I", () -> applyStyle("italic")));
        toolbar.add(createToolbarBtn("U", () -> applyStyle("underline")));
        toolbar.add(new JSeparator(SwingConstants.VERTICAL));
        toolbar.add(createToolbarBtn("H1", () -> applyHeading(24)));
        toolbar.add(createToolbarBtn("H2", () -> applyHeading(18)));
        toolbar.add(new JSeparator(SwingConstants.VERTICAL));
        toolbar.add(createToolbarBtn("• List", () -> insertText("• ")));
        toolbar.add(createToolbarBtn("1. List", () -> insertText("1. ")));
        canvas.add(toolbar);
        canvas.add(Box.createVerticalStrut(8));
    ...
    private JButton createToolbarBtn(String text, Runnable action) {
        JButton btn = new JButton(text);
        btn.setFont(new Font(ColorScheme.FONT_SEMIBOLD.getFamily(), Font.BOLD, 12));
                ...
                try {
                    ...
                    if (currentNote.createdAt != null) {
                        try {
                            ...
                            dateLabel.setText("📅 " + dt.format(DateTimeFormatter.ofPattern("MMM dd, yyyy")));
                            timeLabel.setText("🕐 " + dt.format(DateTimeFormatter.ofPattern("HH:mm")));
                        } catch (Exception ignored) {}
                    }
                } catch (Exception e) {
