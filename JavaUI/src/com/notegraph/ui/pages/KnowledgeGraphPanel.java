...
public class KnowledgeGraphPanel extends JPanel {
    ...
    class GraphCanvas extends JPanel {
        ...
        private void drawEmptyState(Graphics2D g2, int w, int h) {
            ...
            VectorIcon emptyIcon = new VectorIcon(VectorIcon.Type.NAV_KNOWLEDGE_GRAPH, 48, ColorScheme.TEXT_TERTIARY);
            emptyIcon.paintIcon(GraphCanvas.this, g2, (w - 48) / 2, h / 2 - 50);
        ...
        private void drawLegend(Graphics2D g2, int w, int h) {
            ...
            VectorIcon noteIcon = new VectorIcon(VectorIcon.Type.BOOK, 12, ColorScheme.TEXT_SECONDARY);
            noteIcon.paintIcon(GraphCanvas.this, g2, bx + 12, by + 28);
            g2.drawString(noteCount + " Notes", bx + 30, by + 38);
            
            VectorIcon tagIcon = new VectorIcon(VectorIcon.Type.TAG, 12, ColorScheme.TEXT_SECONDARY);
            tagIcon.paintIcon(GraphCanvas.this, g2, bx + 12, by + 46);
            g2.drawString(tagCount + " Tags", bx + 30, by + 56);
            
            VectorIcon linkIcon = new VectorIcon(VectorIcon.Type.LINK, 12, ColorScheme.TEXT_SECONDARY);
            linkIcon.paintIcon(GraphCanvas.this, g2, bx + 12, by + 64);
            g2.drawString(edgeCount + " Connections", bx + 30, by + 74);
