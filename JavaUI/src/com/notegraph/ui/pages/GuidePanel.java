...
public class GuidePanel extends JPanel {
    ...
    private static final String[][] SECTIONS = {
        {"workspaces", "FOLDER", "Workspaces", "Organize your projects", "#3B82F6"},
        {"notes", "BOOK", "Creating & Editing Notes", "Write beautiful notes", "#10B981"},
        {"tags", "TAG", "Tags & Sections", "Categorize your notes", "#8B5CF6"},
        {"graph", "LINK", "Note Graph & Connections", "Visualize your knowledge", "#F59E0B"},
        {"knowledge", "NAV_KNOWLEDGE_GRAPH", "Knowledge Graph", "Overview of your workspace", "#0EA5E9"},
        {"revisions", "NAV_REVISION", "AI Revisions", "Spaced repetition & study plans", "#6366F1"},
        {"favorites", "STAR_FILLED", "Favorites & Search", "Quick access and global search", "#EF4444"},
        {"tips", "SPARKLE", "Pro Tips", "Get the most out of NoteGraph", "#EC4899"},
    };
    ...
    private static final String[][][] CONTENT = {
        ...
        { // Graph
            ...
            {"Chart View", "Toggle to Chart view to visually explore the web of your notes and tags."},
            {"Connection Details", "Click on any tag node to open the Connection Details sidebar."},
        },
        { // Knowledge Graph
            {"Workspace Overview", "The Knowledge Graph provides a high-level summary of your current workspace."},
            {"Metrics", "Quickly see the total number of Notes, Tags, and Inter-Connections you have created."},
        },
        { // Revisions
            {"What are AI Revisions?", "NoteGraph uses AI to generate spaced repetition schedules based on the Ebbinghaus forgetting curve."},
            {"Generate AI Plan", "Click 'Generate AI Plan' to let our AI analyze your notes' complexity and suggest review dates."},
            {"Complexity & Urgency", "The AI assigns a 1-10 complexity score and priority (HIGH, MEDIUM, LOW) to each note."},
            {"Schedule a Revision", "Select a suggested date or pick your own custom time to review the note."},
            {"Track Progress", "Mark scheduled revisions as Done, Skip them, or Delete them from your queue."},
        },
        { // Favorites & Search
            ...
            {"Global Search", "Use the search bar in the top navigation menu from anywhere to instantly find notes."},
        },
        { // Tips
            ...
            {"Export Notes", "Don't forget you can export your notes to Markdown and PDF for offline use!"},
        },
    };
    ...
    private void buildUI() {
        ...
        JLabel headerIcon = new JLabel(new VectorIcon(VectorIcon.Type.BOOK, 28, ColorScheme.TEXT_PRIMARY));
        ...
        JLabel qsTitle = new JLabel("Quick Start", new VectorIcon(VectorIcon.Type.SPARKLE, 14, ColorScheme.TEXT_PRIMARY), SwingConstants.LEFT);
    ...
    private RoundedPanel createSection(int idx) {
        ...
        JLabel iconBox = new JLabel(new VectorIcon(VectorIcon.Type.valueOf(icon), 20, ColorScheme.TEXT_SECONDARY));
