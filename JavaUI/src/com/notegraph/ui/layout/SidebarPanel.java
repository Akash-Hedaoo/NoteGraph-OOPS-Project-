...
public class SidebarPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        wsArrow.setFont(new Font("SansSerif", Font.PLAIN, 10));
        wsArrow.setForeground(ColorScheme.TEXT_TERTIARY);
        wsArrow.setBorder(new EmptyBorder(2, 0, 0, 0));
    ...
    private JPanel createNavItem(String page, VectorIcon.Type iconType, String label) {
        ...
        JLabel iconLbl = new JLabel(new VectorIcon(iconType, 18, active ? ColorScheme.PRIMARY_BLUE : ColorScheme.TEXT_PRIMARY));
    ...
    private void rebuildNav() {
        ...
        navContainer.add(createNavItem("dashboard", VectorIcon.Type.NAV_DASHBOARD, "Dashboard"));
        navContainer.add(Box.createVerticalStrut(4));
        navContainer.add(createNavItem("hierarchy", VectorIcon.Type.NAV_NOTE_GRAPH, "Note Graph"));
        navContainer.add(Box.createVerticalStrut(4));
        navContainer.add(createNavItem("knowledgegraph", VectorIcon.Type.NAV_KNOWLEDGE_GRAPH, "Knowledge Graph"));
        navContainer.add(Box.createVerticalStrut(4));
        navContainer.add(createNavItem("tags", VectorIcon.Type.NAV_TAGS, "Tags"));
        navContainer.add(Box.createVerticalStrut(4));
    ...
    private void showWorkspaceMenu(Component anchor) {
        ...
        for (ApiModels.WorkspaceDto ws : workspaces) {
            JMenuItem item = new JMenuItem(ws.name + (ws.id.equals(currentWsId) ? " (Active)" : ""));
